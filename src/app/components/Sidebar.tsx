...
import { BookOpen, Camera, TrendingUp, Package, User, Menu, X } from "lucide-react";
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-gray-800/90 backdrop-blur-sm border border-gray-700/50 rounded-lg text-gray-300 hover:text-white hover:bg-gray-700/90 transition-all duration-200"
      >
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-40 bg-gray-900/95 backdrop-blur-sm border-r border-gray-700/50
